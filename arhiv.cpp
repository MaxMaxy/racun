...
void Arhiv::on_listWidget_itemDoubleClicked(QListWidgetItem *item) {
    if(ui->comboBox->currentText() == "arhiv_novRacun") {
        ...
        mFile.flush();
        mFile.close();
        racun.PopraviRacun(tmp_list.at(12).toUtf8(), tmp_list.at(4).toUtf8(), tmp_list.at(6).toUtf8(), tmp_list.at(8).toUtf8(), tmp_list.at(22).toUtf8(), tmp_list.at(14).toUtf8(), tmp_list.at(16).toUtf8(), tmp_list.at(18).toUtf8(), tmp_list.at(20).toUtf8(), tmp_list.at(32).toUtf8());
        this->hide();
