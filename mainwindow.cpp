...
MainWindow::MainWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainWindow), m_copy_path(QDir::currentPath() + "/ElraSetiBackup/"), m_currentDir(QDir::currentPath()), m_arhiv_files(m_currentDir + "/arhiv_files.txt"), m_arhiv_login(m_currentDir + "/arhiv_login.txt"),
...
void MainWindow::CheckFiles() {
    ...
    if(!file.exists()) {
        if(file.open(QIODevice::WriteOnly | QIODevice::Text)) {
            ...
            QString shrani("Shrani v: ; " + m_currentDir + " ;\n" + "Backup: ; " + m_copy_path + " ;\n");
            stream << shrani.toUtf8();
            file.flush();
            file.close();
            if(!QDir(m_currentDir + "/IZBRISANI").exists())
                QDir().mkdir(m_currentDir + "/IZBRISANI");
        } else {
        ...
        if(file.open(QIODevice::ReadOnly | QIODevice::Text)) {
            ...
            m_copy_path.remove(0,1);
            m_copy_path.remove(-1,1);
        }
        if (QFile::exists(m_copy_path + "settings.txt")) {
            QFile::remove(m_copy_path + "settings.txt");
        }
        QFile::copy(m_settings, m_copy_path + "settings.txt");
    }
    if(!QDir(m_copy_path).exists())
        QDir().mkdir(m_copy_path);
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_files.txt")) {
            QFile::remove(m_copy_path + "arhiv_files.txt");
            if(file.open(QIODevice::WriteOnly | QIODevice::Truncate)) {
                QTextStream stream(&file);
                stream.setCodec("UTF-8");
                QStringList list;
        ...
        QFile::copy(m_arhiv_files, m_copy_path + "arhiv_files.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_login.txt")) {
            QFile::remove(m_copy_path + "arhiv_login.txt");
        }
        QFile::copy(m_arhiv_login, m_copy_path + "arhiv_login.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_novRacun.txt")) {
            QFile::remove(m_copy_path + "arhiv_novRacun.txt");
        }
        QFile::copy(m_arhiv_novRacun, m_copy_path + "arhiv_novRacun.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_produkti.txt")) {
            QFile::remove(m_copy_path + "arhiv_produkti.txt");
        }
        QFile::copy(m_arhiv_produkti, m_copy_path + "arhiv_produkti.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_stRacuna.txt")) {
            QFile::remove(m_copy_path + "arhiv_stRacuna.txt");
        }
        QFile::copy(m_arhiv_stRacuna, m_copy_path + "arhiv_stRacuna.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_stranke.txt")) {
            QFile::remove(m_copy_path + "arhiv_stranke.txt");
        }
        QFile::copy(m_arhiv_stranke, m_copy_path + "arhiv_stranke.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_upniki.txt")) {
            QFile::remove(m_copy_path + "arhiv_upniki.txt");
        }
        QFile::copy(m_arhiv_upniki, m_copy_path + "arhiv_upniki.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "arhiv_upnikiSeznam.txt")) {
            QFile::remove(m_copy_path + "arhiv_upnikiSeznam.txt");
        }
        QFile::copy(m_arhiv_upnikiSeznam, m_copy_path + "arhiv_upnikiSeznam.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "company_file.txt")) {
            QFile::remove(m_copy_path + "company_file.txt");
        }
        QFile::copy(m_company_file, m_copy_path + "company_file.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "delavni_proces.txt")) {
            QFile::remove(m_copy_path + "delavni_proces.txt");
        }
        QFile::copy(m_delavni_proces, m_copy_path + "delavni_proces.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "login_file.txt")) {
            QFile::remove(m_copy_path + "login_file.txt");
        }
        QFile::copy(m_login_file, m_copy_path + "login_file.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "material.txt")) {
            QFile::remove(m_copy_path + "material.txt");
        }
        QFile::copy(m_material, m_copy_path + "material.txt");
    }
    file.close();
    ...
    if(!file.exists()) {
        ...
        if (QFile::exists(m_copy_path + "num_company.txt")) {
            QFile::remove(m_copy_path + "num_company.txt");
        }
        QFile::copy(m_num_company, m_copy_path + "num_company.txt");
        if(file.open(QIODevice::ReadOnly | QIODevice::Text)) {
            QTextStream stream(&file);
            stream.setCodec("UTF-8");
            QString lastLine("");
