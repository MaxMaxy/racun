    ...
    m_count(true), m_show_child(false)
{
    ...
    ui->treeWidget_material->header()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
    ...
    ui->treeWidget_material->header()->setSectionResizeMode(4, QHeaderView::Stretch);
    ui->treeWidget_material->header()->setStretchLastSection(false);
    ui->treeWidget_materialProdukta->header()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
    ui->treeWidget_materialProdukta->header()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
    ui->treeWidget_materialProdukta->header()->setSectionResizeMode(2, QHeaderView::Stretch);
    ui->treeWidget_materialProdukta->header()->setStretchLastSection(false);
    ui->treeWidget_delo->setColumnCount(2);
    ui->treeWidget_delo->header()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
    ui->treeWidget_delo->header()->setSectionResizeMode(1, QHeaderView::Stretch);
    ui->treeWidget_delo->header()->setStretchLastSection(false);
    ui->treeWidget_deloProdukta->setColumnCount(3);
    ui->treeWidget_deloProdukta->header()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
    ui->treeWidget_deloProdukta->header()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
    ui->treeWidget_deloProdukta->header()->setSectionResizeMode(2, QHeaderView::Stretch);
...
void Kalkulacija::AddRoot(QString id, QString naziv, QString cena, QString kolicina, QString vrstaKolicine, QTreeWidget *tree) {
    ...
    if(m_count) {
        ...
        itm->setBackgroundColor(4,color);
    } else {
        ...
        itm->setBackgroundColor(4,wcolor);
    }
}
